...
# ======= CẤU HÌNH QUẢN TRỊ =======
ADMIN_PIN = "19022011"  # PIN admin, bạn có thể đổi
TIMEZONE = pytz.timezone('Asia/Ho_Chi_Minh')

# ======= DANH SÁCH KEY & QUYỀN HẠN =======
KEYS = {
...
def login():
    ...
    <body>
        <div class="login-box">
            ...
            <footer>© 2025 ❄️ Tấn Khang 🌠</footer>
        </div>
    </body>
    </html>
    """)
...
def welcome():
    ...
    <head>
        <meta charset="UTF-8">
        <title>🎉 Đăng Nhập Thành Công - Tấn Khangi</title>
        <style>
            body {
    ...
    <body>
        <div class="welcome-container">
            ...
            <div class="welcome-text">🎉 Chào mừng đến với Web by Tấn Khang</div>
...
def menu():
    ...
    <head>
        <meta charset="UTF-8">
        <title>🌐 Menu Chính - Tấn Khang</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <footer>
            <div>© 2025 ❄️Tấn Khang - "Where Legends Are Born" 🌠</div>
